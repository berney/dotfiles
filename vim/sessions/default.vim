...
nnoremap <silent> ,k :ALEPreviousWrap
nnoremap <silent> ,j :ALENextWrap
...
set nomodeline
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-monokai/,~/.vim/plugged/vim-monokai-tasty/,~/.vim/plugged/sonokai/,~/.vim/plugged/edge/,~/.vim/plugged/forest-night/,~/.vim/plugged/gruvbox-material/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-airline-themes/,~/.vim/plugged/vim-colorschemes/,~/.vim/plugged/vim-ruby/,~/.vim/plugged/vim-go/,~/.vim/plugged/vim-terraform/,~/.vim/plugged/vim-terraform-completion/,~/.vim/plugged/ale/,~/.vim/plugged/coc.nvim/,~/.vim/plugged/mycomment.vim/,~/.vim/plugged/indentLine/,~/.vim/plugged/vim-fugitive/,~/.vim/plugged/vim-indentwise/,~/.vim/plugged/vim-plugin-AnsiEsc/,~/.vim/plugged/limelight.vim/,~/.vim/plugged/ctrlsf.vim/,~/.vim/plugged/vim-lexical/,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/plugged/ctrlsf.vim/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets,~/.config/coc/extensions/node_modules/coc-explorer
...
let s:l = 236 - ((0 * winheight(0) + 17) / 34)
