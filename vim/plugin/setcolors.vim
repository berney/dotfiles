...
let s:mycolors = ['monokai', 'monokai-chris', 'monokain', 'PaperColor', 'gruvbox', 'slate', 'torte', 'darkblue', 'delek', 'murphy', 'elflord', 'pablo', 'koehler']  " colorscheme names that we use to set color
